...
<p align="center"><img alt="OSPTEK 1.96 寸 410×502 AMOLED QSPI 模组（CO5300）宣传图" src="./images/product.png" width="640" /></p>
...
OSPTEK **1.96 寸 410×502 AMOLED** 是一款 **QSPI** 接口彩色显示模组，显示驱动为 **CO5300**，触摸驱动为 **CST820**。适合手持终端、穿戴与小型竖屏 HMI 等场景。

规格标识（仓库名）：`amoled-1.96-410x502-qspi-co5300`

当前模组版本：**AM196Q410502LK**。电气与外形细节以 [`docs/AM_196_Q410502_LK_0710e73b4c.pdf`](./docs/AM_196_Q410502_LK_0710e73b4c.pdf) 为准。
...
```text
amoled-1.96-410x502-qspi-co5300/                                # 仓库根（导航见 ../../README.md）
└── versions/
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（AM196Q410502LK） | [`docs/AM_196_Q410502_LK_0710e73b4c.pdf`](./docs/AM_196_Q410502_LK_0710e73b4c.pdf) |
...
| 初始化序列（文本） | [`docs/Truly1.952_CO5300_BV6802_QSPI_简码_20240314.txt`](./docs/Truly1.952_CO5300_BV6802_QSPI_%E7%AE%80%E7%A0%81_20240314.txt) |
| 1.96 寸 AMOLED 转接板原理图 | [`docs/1.96寸AMOLED转接板原理图.png`](./docs/1.96%E5%AF%B8AMOLED%E8%BD%AC%E6%8E%A5%E6%9D%BF%E5%8E%9F%E7%90%86%E5%9B%BE.png) |
| 1.96 / 2.13 AMOLED 转接板 | [`docs/PCB-1.96&2.13AMOLED转接板.pdf`](./docs/PCB-1.96%262.13AMOLED%E8%BD%AC%E6%8E%A5%E6%9D%BF.pdf) |
